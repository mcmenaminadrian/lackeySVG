 ...
 *
 */
class GraphFIFOTheta {

	/**
	 * Graph lifetime fuction using FIFO method of caching
	 * @param thetaFIFOMap data about FIFO cache
		...
		def boostSize)
	{
		...
		def rangeT = maxT 
		def rangeG = maxG
		def writer = new FileWriter ("FIFOTHETA${new Date().time.toString()}.svg")
